...
class GeometriesTests {
    ...
    void findIntersections() {
        ...
        assertNull(geometries2.findIntersections(new Ray(new Vector(0, 0, 1), new Point(8.5, 7.5, 4))), "Wrong number of points");
        ...
        List<Point> result3 = geometries.findIntersections(new Ray(new Vector(0, 1, 0), new Point(0.5, 0.5, -0.5)));
