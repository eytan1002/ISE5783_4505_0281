...
public class SphereTests {
     ...
     */
    /**
     @Test public void FindIntersectionsest() {
     ...
     assertNull(sphere.findIntersections(new Ray(new Point(2.5, 0, 0), new Vector(3, 1, 0))),
     "Ray's line out of sphere");
     ...
     assertEquals(List.of(p4), sphere.findIntersections(new Ray(new Point(1, 0, -1), new Vector(3, 3, 5)
     )), "Ray intersection has 1 point");


     // TC12: Ray starts at sphere and goes outside (0 points)
     assertNull(sphere.findIntersections(new Ray(new Point(2, 0, 0), new Vector(3, 3, 5))),
     "Ray's line out of sphere");
     ...
     List<Point> result3 = sphere.findIntersections(new Ray(new Point(0, -1, -1), new Vector(1, 1, 1)
     ));
     ...
     List<Point> resultC2 = sphere.findIntersections(new Ray(new Point(2, 0, 0), new Vector(-1, 0, 0)
     ));
     ...
     List<Point> resultC3 = sphere.findIntersections(new Ray(new Point(0.5, 0.5, 0.5), new Vector(1, -1, -1)
     ));
     ...
     List<Point> resultC4 = sphere.findIntersections(new Ray(new Point(1, 0, 0), new Vector(1, 21, 1)
     ));
     ...
     assertNull(sphere.findIntersections(new Ray(new Point(2, 0, -3), new Vector(0, 0, 1))),
     "Ray's line out of sphere");
     ...
     assertNull(sphere.findIntersections(new Ray(p_o, new Vector(0, 1, 0))),
     "Ray's line out of sphere");
     }
     **/
}